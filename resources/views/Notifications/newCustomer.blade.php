            ...
            <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
                ...
                <tr>
                    <td valign="middle" class="hero bg_white"
                        style="background-image: url({{ asset('img_static/cover.jpg') }}); background-size: cover; height: 400px;">
                            ...
                            <tr>
                                <td>
                                    <div class="text" style="padding: 0 4em; text-align: center;">
                                        ...
                                        <h2>WAAM 4 Medical Services</h2>
                                        <p>To become market leaders in medical and pharmaceutical service, by providing
                                            reliable value -added solutions to our
                                            customers.</p>
                                        <p><a href="https://waam4.com/" class="btn btn-primary">Shop Now</a></p>
                                    </div>
                                </td>
                            </tr>
                        </table>
                ...
                <tr>
                    <td class="bg_white email-section">
                        <div class="heading-section" style="text-align: center; padding: 0 30px;">
                            <h2>Through a special control panel, you can track your current and upcoming orders</h2>
                        </div>
                                ...
                                <td style="padding-bottom: 30px;">
                                    <table role="presentation" border="0" cellpadding="0" cellspacing="0"
                                        ...
                                        <td valign="middle" width="50%">
                                            <img src="{{ asset('img_static/img.jpg') }}" alt=""
                                        ...
                                        <td valign="middle" width="50%">
                                            <div class="text-blog" style="text-align: left; padding-left:25px;">
                                                ...
                                                <p><a href="https://waam4.com/login" class="btn btn-primary">Sign in</a>
                                                </p>
                                            </div>
                                        </td>
                                    </table>
                                    ...
                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0"
                                        ...
                                        <tr>
                                            <td style="text-align: left; padding-right: 1px;">
                                                <p>&copy; 2023 WAAM4. All Rights Reserved</p>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
