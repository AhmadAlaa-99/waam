                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('categories.store') }}" method="post"
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <h5 class="form-title"><span>Add Categories</span></h5>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="student-submit">
                                            <button type="submit"
                                                class="btn btn-primary"name="action"value="save">Submit</button>
                                            <button type="submit"
                                                class="btn btn-primary"name="action"value="save_and_add_com">Submit And add
                                                more</button>
                                        </div>
                                    </div>
